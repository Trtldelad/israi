...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/mjaZFnf1iuQ6iWEgT3QCzWacQ9m1/social-images/social-1777355739250-95319706-7c06-4f38-ae7b-54d0fab0f8cf.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/mjaZFnf1iuQ6iWEgT3QCzWacQ9m1/social-images/social-1777355739250-95319706-7c06-4f38-ae7b-54d0fab0f8cf.webp" },
    ],
    links: [
      {
        rel: "stylesheet",
